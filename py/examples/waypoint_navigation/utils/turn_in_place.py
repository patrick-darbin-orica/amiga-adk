...
async def main(args) -> None:
    ...
    sign: float = 1.0 if args.direction == "left" else -1.0
    ...
    try:
        ...
        track_builder.create_turn_segment(f"{angle}_deg_turn_in_place", angle=radians(angle) * sign, spacing=0.05)
...
if __name__ == "__main__":
    ...
    # Required argument
    parser.add_argument("--angle", type=float, default=15.0, help="Angle to turn in place (degrees, default: 15.0)")
    parser.add_argument(
        "--direction", type=str, choices=["left", "right"], default="left", help="Direction of the turn (default: left)"
    )
